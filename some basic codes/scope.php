...
// inn php global variable dont have access to the function until defined
// to access the global variable inside the function then we use the global keyboard
//
?>